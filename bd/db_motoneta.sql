...
(
  ...
  INSERT INTO `material_aceptado` (`
  nombre_material`,
  `condicion_entrega
  `, `imagen_material`) VALUES
  ...
  ('Carton', 'El cartón debe estar limpio y si es una caja también debe estar desarmada.', './back/images/cardboard.jpeg'),
  ('Envases plasticos', 'Se acepta cualquier envase que tenga un Código de Identificación Plástico o RIC (Resin Identification Code), a excepción de  los de yogur o queso blanco, los plásticos mezclados con otros materiales o los degradados por el sol.', './back/images/plasticBottles.jpeg'),
  ('Latas de conserva', 'No deben estar oxidadas.', './back/images/cans.jpeg'),
  ('Tetrabrik', 'Solo se aceptarán limpios, secos y aplastados.', './back/images/boxTetrabrik.jpeg'),
  ...
  id_ciudadano`,
  `nombre
  `, `apellido`, `direccion`, `telefono`) VALUES
  (1,'Lucas','Warrior','Calle Falsa 123',2983112233);
  INSERT INTO `ciudadano`(`
  id_ciudadano`,
  `nombre
  `, `apellido`, `direccion`, `telefono`) VALUES
  (2,'Motoneta','Martinez','Av. Siempre Viva 742',2983456789);
  INSERT INTO `ciudadano`(`
  id_ciudadano`,
  `nombre
  `, `apellido`, `direccion`, `telefono`) VALUES
  (3,'Juan','Pisarra','Lorem Ipsum 666', 2983111111);
  INSERT INTO `ciudadano`(`
  id_ciudadano`,
  `nombre
  `, `apellido`, `direccion`, `telefono`) VALUES
  (4,'Franca','Molfese','Av. San Martín 567', 2983222222);
  INSERT INTO `ciudadano`(`
  id_ciudadano`,
  `nombre
  `, `apellido`, `direccion`, `telefono`) VALUES
  (5,'Cristina','Tisera','Las Heras 111', 2983434343);

  INSERT INTO `pedido_cartonero`(`
  id_ciudadano`,
  `fecha_pedido
  `, `id_franja_horaria`, `volumen_id_volumen`, `imagen`) VALUES
  (1, '2021-11-24', 1, 1, null);
  INSERT INTO `pedido_cartonero`(`
  id_ciudadano`,
  `fecha_pedido
  `, `id_franja_horaria`, `volumen_id_volumen`, `imagen`) VALUES
  (1, '2021-11-26', 2, 2, null);
  INSERT INTO `pedido_cartonero`(`
  id_ciudadano`,
  `fecha_pedido
  `, `id_franja_horaria`, `volumen_id_volumen`, `imagen`) VALUES
  (2, '2021-11-22', 2, 2, null);
  INSERT INTO `pedido_cartonero`(`
  id_ciudadano`,
  `fecha_pedido
  `, `id_franja_horaria`, `volumen_id_volumen`, `imagen`) VALUES
  (3, '2021-11-21', 1, 4, null);
  INSERT INTO `pedido_cartonero`(`
  id_ciudadano`,
  `fecha_pedido
  `, `id_franja_horaria`, `volumen_id_volumen`, `imagen`) VALUES
  (4, '2021-11-30', 1, 3, null);
  INSERT INTO `pedido_cartonero`(`
  id_ciudadano`,
  `fecha_pedido
  `, `id_franja_horaria`, `volumen_id_volumen`, `imagen`) VALUES
  (5, '2021-11-19', 2, 2, null);
